...
export function useSelection<T = unknown, C extends Cardinality = "single">(props: SelectionProps<T, C>, emits: Emit<SelectionEmits<T, C>>, options?: Partial<SelectionOptions<T, C>>): Selection<T, C> {
